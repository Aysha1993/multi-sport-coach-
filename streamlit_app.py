...
st.title("🎾 TrackNet Tennis Analyzer with TrackNet + HSV Fallback + LLM Feedback")
...
if uploaded_video:
    ...
    # ===============================
    # Display outputs & download
    # ===============================
    st.subheader("🎯 Trajectory CSV & Annotated Video")
    st.download_button("⬇️ Download Trajectory CSV", data=open(OUTPUT_CSV,"rb"), file_name="trajectory.csv")
    st.video(OUTPUT_VIDEO)
    st.download_button("⬇️ Download Annotated Video", data=open(OUTPUT_VIDEO,"rb"), file_name="annotated_output.mp4")
